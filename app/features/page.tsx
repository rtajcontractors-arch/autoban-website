...
import { InvoiceVisualCard, PayrollVisualCard } from "@/components/CountryAwareVisuals";
      ...
      {mainFeatures.map((f, idx) => (
        <section key={f.title} style={{
          ...
          <div className="grid-2" style={{
            ...
            <div style={{ direction: "rtl" }}>
              {idx === 0 ? <InvoiceVisualCard /> : idx === 3 ? <PayrollVisualCard /> : <VisualCard rows={f.visual} />}
            </div>
          </div>
        </section>
      ))}
